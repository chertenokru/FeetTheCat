...
public class LogoPanel extends DrawPanel {
    ...
    public void run() {
        ...
        imageList.put("1",new ImageData(image, 0, panelHeight - image.getHeight(null), image.getWidth(null), image.getHeight(null)));
        this.repaint();
        // прогресс бар
        ...
        imageList.put("4",new ImageData(image, 0, 0, image.getWidth(null), image.getHeight(null)));
        repaint();
        sleep(3000);
